        ...
        */
        ...
        public class Mem0Global
        {
            ...
            */
            ...
            public int nPageFree; /* Number of free pages for scratch and page-cache memory */
                ...
                int Mem_Allocation, int BtCursor_Allocation)
            {
                ...
                for (var i = 0; i < aByteSize.Length; i++)
                    aByte[i] = new byte[Byte_Allocation][];
    ...
    */
        ...
        */
        private static int sqlite3MallocInit()
        {
            ...
            if (sqlite3GlobalConfig.bCoreMutex) mem0.mutex = sqlite3MutexAlloc(SQLITE_MUTEX_STATIC_MEM);
        ...
        */
        private static int mallocWithAlarm(int n, ref int[] pp)
        {
            ...
            if (mem0.alarmCallback != null)
            {
                var nUsed = sqlite3StatusValue(SQLITE_STATUS_MEMORY_USED);
...
p = sqlite3GlobalConfig.m.xMalloc(nFull);
        ...
        private static int mallocWithAlarm(int n, ref byte[] pp)
        {
            ...
            {
                var nUsed = sqlite3StatusValue(SQLITE_STATUS_MEMORY_USED);
                if (nUsed + nFull >= mem0.alarmThreshold) sqlite3MallocAlarm(nFull);
            }
        ...
        */
        ...
        private static int[] sqlite3Malloc(int[] pInt, uint n)
        {
        ...
        private static byte[] sqlite3Malloc(uint n)
        {
        ...
        ** allocation.
        */
        private static byte[] sqlite3_malloc(int n)
        {
#if !SQLITE_OMIT_AUTOINIT
        ...
        */
        ...
        private static int scratchAllocOut;
#endif
    ...
    */
      ...
      ** would be much more complicated.) */
            ...
            if (sqlite3GlobalConfig.szScratch < n) goto scratch_overflow;
...
return p && p>=db.lookaside.pStart && p<db.lookaside.pEnd;
    ...
    */
        ...
        private static int sqlite3DbMallocSize(sqlite3 db, byte[] p)
        {
            ...
            if (db != null && isLookaside(db, p)) return db.lookaside.sz;
        ...
        */
        ...
        private static void sqlite3_free(ref Mem p)
        {
            if (p == null)
                return;
            if (sqlite3GlobalConfig.bMemstat)
...
db.lookaside.nOut--;
        ...
        */
        ...
        {
            var p = sqlite3Malloc(n);
            if (p != null) Array.Clear(p, 0, n); // memset(p, 0, n);
            return p;
        }
...
((db !=null && db.lookaside.bEnabled) ? MEMTYPE_LOOKASIDE : MEMTYPE_HEAP));
        ...
        */
        private static byte[] sqlite3DbRealloc(sqlite3 db, byte[] p, int n)
        {
            ...
            if (p == null) return sqlite3DbMallocRaw(db, n);
#if !SQLITE_OMIT_LOOKASIDE
if( isLookaside(db, p) ){
if( n<=db->lookaside.sz ){
return p;
...
(db.lookaside.bEnabled ? MEMTYPE_LOOKASIDE : MEMTYPE_HEAP));
        ...
        */
        private static byte[] sqlite3DbReallocOrFree(sqlite3 db, byte[] p, int n)
        {
            ...
            if (null == pNew) sqlite3DbFree(db, ref p);
            return pNew;
        }
