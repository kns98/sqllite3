...
namespace Community.CsharpSqlite
{
    ...
    public partial class Sqlite3
    {
        ...
        */
        ...
        )
        {
            ...
            if (pOrig.op != TK_COLUMN && (zType.Length == 0 || zType[0] != 'G'))
            {
                ...
                if (pDup == null)
                    return;
                if (pEList.a[iCol].iAlias == 0) pEList.a[iCol].iAlias = (ushort)++pParse.nAlias;
        ...
        */
        ...
        )
        {
                        ...
                        if (zTab != null)
                        {
                            ...
                            else
                            {
                                ...
                                if (NEVER(zTabName == null) ||
                                    !zTabName.Equals(zTab, StringComparison.InvariantCultureIgnoreCase)) continue;
                                if (zDb != null && !db.aDb[iDb].zName
                                        .Equals(zDb, StringComparison.InvariantCultureIgnoreCase)) continue;
                            }
                        }
                        ...
                        for (j = 0; j < pTab.nCol; j++) //, pCol++ )
                        {
                            ...
                            ** to avoid a duplicate match there. */
                                        ...
                                        for (k = 0; k < pUsing.nId; k++)
                                            if (pUsing.a[k].zName.Equals(zCol,
                ...
                */
                if (zDb == null && zTab != null && cnt == 0 && pParse.pTriggerTab != null)
                {
                    ...
                    if (pTab != null)
                    {
                        ...
                        {
                            var pCol = pTab.aCol[iCol];
                            if (pCol.zName.Equals(zCol, StringComparison.InvariantCultureIgnoreCase))
                            {
                                if (iCol == pTab.iPKey) iCol = -1;
                                break;
                            }
                        }

                        if (iCol >= pTab.nCol && sqlite3IsRowid(zCol)) iCol = -1; /* IMP: R-44911-55124 */
                        if (iCol < pTab.nCol)
                        {
                            cnt++;
                            if (iCol < 0)
            ...
            */
            ...
            pExpr.pRight = null;
            pExpr.op = (byte)(isTrigger != 0 ? TK_TRIGGER : TK_COLUMN);
            lookupname_end:
            if (cnt == 1)
            {
        ...
        */
        ...
        {
            var p = sqlite3ExprAlloc(db, TK_COLUMN, null, 0);
            if (p != null)
            {
                var pItem = pSrc.a[iSrc];
                p.pTab = pItem.pTab;
                ...
                else
                {
                    ...
                    testcase(iCol == BMS);
                    testcase(iCol == BMS - 1);
                    pItem.colUsed |= (ulong)1 << (iCol >= BMS ? BMS - 1 : iCol);
                }
        ...
        )
        {
            ...
            if (pE.op == TK_ID)
            {
                ...
                for (i = 0; i < pEList.nExpr; i++)
                {
                    ...
                    if (zAs != null && zAs.Equals(zCol, StringComparison.InvariantCultureIgnoreCase)) return i + 1;
                }
            }
                ...
                for (i = 0; i < pOrderBy.nExpr; i++) //, pItem++)
                {
                    ...
                    if (iCol > 0)
                    {
                        ...
                        if (pE == null)
                            return 1;
                        pE.pColl = pColl;
                        pE.flags = (ushort)(pE.flags | EP_IntValue | flags);
                        pE.u.iValue = iCol;
