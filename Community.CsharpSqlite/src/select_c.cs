    ...
    public partial class Sqlite3
    {
        ...
        */
        ...
        )
        {
            ...
            pNew.selFlags = (ushort)(isDistinct != 0 ? SF_Distinct : 0);
            pNew.op = TK_SELECT;
            pNew.pLimit = pLimit;
        ...
        */
        ...
        {
            public readonly byte code; /* Join type mask */
            public readonly byte i; /* Beginning of keyword text in zKeyText[] */
            public readonly byte nChar; /* Length of the keyword in characters */
...
/* cross   */ new Keyword(28, 5, JT_INNER | JT_CROSS)
        ...
        */
        ...
        )
        {
            ...
            if (pEq != null && isOuterJoin != 0)
            {
                ...
                pEq.iRightJoinTable = (short)pE2.iTable;
            }
                ...
                */
                if ((pRight.jointype & JT_NATURAL) != 0)
                {
                    ...
                    for (j = 0; j < pRightTab.nCol; j++)
                    {
                        ...
                        var iLeft = 0; /* Matching left table */
                        var iLeftCol = 0; /* Matching column in the left table */

                        zName = pRightTab.aCol[j].zName;
                        var iRightCol = columnIndex(pRightTab, zName);
                ...
                */
                if (pRight.pUsing != null)
                {
                    ...
                    for (j = 0; j < pList.nId; j++)
                    {
                        ...
                        var iLeft = 0; /* Table on the left with matching column name */
                        var iLeftCol = 0; /* Column number of matching column on the left */
    ...
    */
        ...
        */
            ...
            ** the output for us.
            */
            if (pOrderBy == null && p.iLimit != 0) sqlite3VdbeAddOp3(v, OP_IfZero, p.iLimit, iBreak, -1);
        }
    ...
    */
        private static void explainTempTable(Parse pParse, string zUsage)
        {
            ...
            {
                var v = pParse.pVdbe;
                var zMsg = sqlite3MPrintf(pParse.db, "USE TEMP B-TREE FOR %s", zUsage);
            ...
            switch (eDest)
            {
                ...
                default:
                {
                    ...
                    for (i = 0; i < nColumn; i++)
                    {
                        ...
                        if (i == 0) sqlite3VdbeChangeP5(v, OPFLAG_CLEARCACHE);
                    }
...
#if !SQLITE_OMIT_EXPLAIN
            var iSub1 = 0; /* EQP id of left-hand query */
            var iSub2 = 0; /* EQP id of right-hand query */
#endif
...
break;
        ...
        */
            ...
            */
            if (p.iLimit != 0) sqlite3VdbeAddOp3(v, OP_IfZero, p.iLimit, iBreak, -1);
            ...
            if (op != TK_ALL)
                for (i = 1; /* db.mallocFailed == 0 && */ i <= p.pEList.nExpr; i++)
                {
                    ...
                    if (j == nOrderBy)
                    {
                        ...
                        pOrderBy.a[nOrderBy++].iCol = (ushort)i;
                    }
                }
            ...
            */
            ...
            if (aPermute != null)
            {
                ...
                if (pKeyMerge != null)
                {
                    ...
                    pKeyMerge.nField = (ushort)nOrderBy;
    ...
    */
        ...
        )
        {
            ...
            ** and (14). */
            ...
            if (p.pRightmost != null && pSub.pLimit != null) return 0; /* Restriction (15) */
            if (pSubSrc.nSrc == 0)
                return 0; /* Restriction (7)  */
            if ((pSub.selFlags & SF_Distinct) != 0)
                return 0; /* Restriction (5)  */
            if (pSub.pLimit != null && (pSrc.nSrc > 1 || isAgg)) return 0; /* Restrictions (8)(9) */
            ...
            if (pSub.pLimit != null && (p.selFlags & SF_Distinct) != 0) return 0; /* Restriction (21) */
            ...
            */
            for (pParent = p; pParent != null; pParent = pParent.pPrior, pSub = pSub.pPrior)
            {
                ...
                */
                pParent.selFlags = (ushort)(pParent.selFlags | (pSub.selFlags & SF_Distinct));
        ...
        private static int sqlite3IndexedByLookup(Parse pParse, SrcList_item pFrom)
        {
            if (pFrom.pTab != null && pFrom.zIndex != null && pFrom.zIndex.Length != 0)
            {
                ...
                for (pIdx = pTab.pIndex;
                     pIdx != null && !pIdx.zName.Equals(zIndex,
                         StringComparison.InvariantCultureIgnoreCase);
                     pIdx = pIdx.pNext
                    )
                    ;
                    ...
                    else
                    {
                        ...
                        ** expanded. */
                        ...
                        for (i = 0; i < pTabList.nSrc; i++) //, pFrom++ )
                        {
                            ...
                            if (zTName != null && !zTName.Equals(zTabName,
                                ...
                                */
                                ...
                                if (i > 0 && (zTName == null || zTName.Length == 0))
                                {
                                    ...
                                    if ((pFrom.jointype & JT_NATURAL) != 0
                                        && tableAndColumnIndex(pTabList, i, zName, ref iDummy,
                                            ref iDummy) != 0
                                       )
                                        ...
                                        if (sqlite3IdListIndex(pFrom.pUsing, zName) >= 0)
                                          ...
                                          ** using clause from the table on the right. */
                                            ...
                                            if (longNames || pTabList.nSrc > 1)
                                            {
                                                ...
                                                if (longNames)
                                                {
                                                    zColname = sqlite3MPrintf(db, "%s.%s", zTabName,
                                                        zName);
                                                    zToFree = zColname;
                                                }
                                            }
...
//#if SQLITE_MAX_COLUMN
                                            if (p.pEList != null && p.pEList.nExpr >
                                            ...
                                            */
                                            private static int exprWalkNoop(Walker NotUsed,
                                                ref Expr NotUsed2)
                                            {
                                            ...
                                            */
                                            private static void sqlite3SelectExpand(Parse pParse,
                                                Select pSelect)
                                            {
                                                var w = new Walker();
                                        ...
                                        */
                                            private static int selectAddSubqueryTypeInfo(Walker pWalker,
                                                Select p)
                                            {
                                                Parse pParse;
                                                int i;
                                        ...
                                        */
                                            private static void sqlite3SelectAddTypeInfo(Parse pParse,
                                                Select pSelect)
                                            {
#if !SQLITE_OMIT_SUBQUERY
                                                var w = new Walker();
                                            ...
                                            */
                                            private static void resetAccumulator(Parse pParse,
                                                AggInfo pAggInfo)
                                            {
                                                var v = pParse.pVdbe;
                                                int i;
                                                ...
                                                for (i = 0; i < pAggInfo.nFunc; i++)
                                                {
                                                    ...
                                                    if (pFunc.iDistinct >= 0)
                                                    {
                                                        ...
                                                        {
                                                            var pKeyInfo = keyInfoFromExprList(pParse,
                                                                pE.x.pList);
                                            ...
                                            */
                                            private static void finalizeAggFunctions(Parse pParse,
                                                AggInfo pAggInfo)
                                            {
                                                var v = pParse.pVdbe;
                                                int i;
                                                ...
                                                for (i = 0; i < pAggInfo.nFunc; i++)
                                                {
                                                    ...
                                                    Debug.Assert(!ExprHasProperty(pF.pExpr,
                                                        EP_xIsSelect));
                                                    sqlite3VdbeAddOp4(v, OP_AggFinal, pF.iMem,
                                                        pList != null ? pList.nExpr : 0, 0,
                                                        pF.pFunc, P4_FUNCDEF);
                                                }
                                            }
                                            ...
                                            */
                                            private static void updateAccumulator(Parse pParse,
                                                AggInfo pAggInfo)
                                            {
                                                var v = pParse.pVdbe;
                                                int i;
                                                ...
                                                for (i = 0; i < pAggInfo.nFunc; i++)
                                                {
                                                    ...
                                                    if ((pF.pFunc.flags & SQLITE_FUNC_NEEDCOLL) != 0)
                                                    {
                                                        ...
                                                        int j;
                                                        Debug.Assert(pList !=
                                                                     null); /* pList!=0 if pF->pFunc has NEEDCOLL */
                                                        ...
                                                        sqlite3VdbeAddOp4(v, OP_CollSeq, 0, 0, 0, pColl,
                                                            P4_COLLSEQ);
                                                    }

                                                    sqlite3VdbeAddOp4(v, OP_AggStep, 0, regAgg, pF.iMem,
                                                        pF.pFunc, P4_FUNCDEF);
                                                    sqlite3VdbeChangeP5(v, (byte)nArg);
                                                    sqlite3ExprCacheAffinityChange(pParse, regAgg,
                                                        nArg);
                                            ...
                                            */
                                            ...
                                            )
                                            {
                                                if (pParse.explain == 2)
                                                {
                                                    var zEqp = sqlite3MPrintf(pParse.db,
                                                    ...
                                                    sqlite3VdbeAddOp4(
                                                        pParse.pVdbe, OP_Explain, pParse.iSelectId, 0,
                                                        0, zEqp, P4_DYNAMIC
                                                    );
                                                }
                                            }
    ...
    static void explainSimpleCount(Parse a, Table b, Index c){}
                                            ...
                                            */
                                            ...
                                            )
                                            {
                                                ...
                                                var pEList =
                                                    new ExprList(); /* List of columns to extract. */
                                                var pTabList =
                                                    new SrcList(); /* List of tables to select from */
                                                Expr pWhere; /* The WHERE clause.  May be NULL */
                                                ExprList
                                                    pOrderBy; /* The ORDER BY clause.  May be NULL */
                                                ExprList
                                                    pGroupBy; /* The GROUP BY clause.  May be NULL */
                                                Expr pHaving; /* The HAVING clause.  May be NULL */
                                                bool
                                                    isDistinct; /* True if the DISTINCT keyword is present */
                                                int distinct; /* Table to use for the distinct set */
                                                var rc = 1; /* Value to return from this function */
                                                int
                                                    addrSortIndex; /* Address of an OP_OpenEphemeral instruction */
                                                AggInfo
                                                    sAggInfo; /* Information used by aggregate queries */
                                                int iEnd; /* Address of the end of the query */
                                                sqlite3 db; /* The database connection */

#if !SQLITE_OMIT_EXPLAIN
                                                var iRestoreSelectId = pParse.iSelectId;
                                                pParse.iSelectId = pParse.iNextSelectId++;
#endif

                                                db = pParse.db;
                                                if (p == null /*|| db.mallocFailed != 0 */ ||
                                                    pParse.nErr != 0) return 1;
#if !SQLITE_OMIT_AUTHORIZATION
if (sqlite3AuthCheck(pParse, SQLITE_SELECT, 0, 0, 0)) return 1;
#endif
                                                sAggInfo =
                                                    new AggInfo(); // memset(sAggInfo, 0, sAggInfo).Length;

                                                if (pDest.eDest <=
                                                    SRT_Discard) //IgnorableOrderby(pDest))
                                                {
                                                    ...
                                                    ** DISTINCT so it can be removed too. */
                                                    sqlite3ExprListDelete(db, ref p.pOrderBy);
                                                    p.pOrderBy = null;
                                                    p.selFlags = (ushort)(p.selFlags & ~SF_Distinct);
                                                }
                                                ...
                                                */
#if !SQLITE_OMIT_SUBQUERY
                                                if (checkForMultiColumnSelectError(pParse, pDest,
                                                        pEList.nExpr)) goto select_end;
#endif
                                                ...
                                                for (i = 0; p.pPrior == null && i < pTabList.nSrc; i++)
                                                {
                                                    ...
                                                    */
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        explainSetInteger(ref pItem.iSelectId,
                                                    ...
                                                    pTabList = p.pSrc;
                                                    if (!(pDest.eDest <=
                                                          SRT_Discard)) //        if( null==IgnorableOrderby(pDest) )
                                                        pOrderBy = p.pOrderBy;
                                                }
                                          ...
                                          */
                                                if (p.pPrior != null)
                                                {
                                                    ...
                                                    explainSetInteger(ref pParse.iSelectId,
                                                        iRestoreSelectId);
                                                    return rc;
                                                }
#endif
                                          ...
                                          */
                                                ...
                                                */
                                                if (pDest.eDest == SRT_EphemTab)
                                                    sqlite3VdbeAddOp2(v, OP_OpenEphemeral, pDest.iParm,
                                                        pEList.nExpr);
                                                ...
                                                */
                                                if ((p.selFlags & SF_Distinct) != 0)
                                                {
                                                    ...
                                                    sqlite3VdbeAddOp4(v, OP_OpenEphemeral, distinct, 0,
                                                        0,
                                                        pKeyInfo, P4_KEYINFO_HANDOFF);
                                                    sqlite3VdbeChangeP5(v, BTREE_UNORDERED);
                                                }
                                                ...
                                                if (!isAgg && pGroupBy == null)
                                                {
                                                    ...
                                                    */
                                                    ...
                                                    selectInnerLoop(pParse, p, pEList, 0, 0, pOrderBy,
                                                        -1, pDest,
                                                ...
                                                else
                                                {
                                                    ...
                                                    NameContext
                                                        sNC; /* Name context for processing aggregate information */
                                                    int
                                                        iAMem; /* First Mem address for storing current GROUP BY */
                                                    int
                                                        iBMem; /* First Mem address for previous GROUP BY */
                                                    int
                                                        iUseFlag; /* Mem address holding flag indicating that at least
** one row of the input to the aggregator has been
** processed */
                                                    int
                                                        iAbortFlag; /* Mem address which causes query abort if positive */
                                                    int
                                                        groupBySort; /* Rows come from source in GR BY' clause thanROUP BY order */
                                                    ...
                                                    */
                                                    if (pGroupBy != null)
                                                    {
                                                        int k; /* Loop counter */
                                                        ExprList_item
                                                            pItem; /* For looping over expression in a list */
                                                    ...
                                                    */
                                                    sNC =
                                                        new NameContext(); // memset(sNC, 0, sNC).Length;
                                                    sNC.pParse = pParse;
                                                    sNC.pSrcList = pTabList;
                                                    sNC.pAggInfo = sAggInfo;
                                                    sAggInfo.nSortingColumn =
                                                        pGroupBy != null ? pGroupBy.nExpr + 1 : 0;
                                                    ...
                                                    {
                                                        Debug.Assert(
                                                            !ExprHasProperty(sAggInfo.aFunc[i].pExpr,
                                                                EP_xIsSelect));
                                                        sqlite3ExprAnalyzeAggList(sNC,
                                                            sAggInfo.aFunc[i].pExpr.x.pList);
                                                    }
                                                    ...
                                                    */
                                                    ...
                                                    {
                                                        KeyInfo
                                                            pKeyInfo; /* Keying information for the group by clause */
                                                        int j1; /* A-vs-B comparision jump */
                                                        int
                                                            addrOutputRow; /* Start of subroutine that outputs a result row */
                                                        int
                                                            regOutputRow; /* Return address register for output subroutine */
                                                        int
                                                            addrSetAbort; /* Set the abort flag and return */
                                                        int addrTopOfLoop; /* Top of the input loop */
                                                        int
                                                            addrSortingIdx; /* The OP_OpenEphemeral for the sorting index */
                                                        int
                                                            addrReset; /* Subroutine for resetting the accumulator */
                                                        int
                                                            regReset; /* Return address register for reset subroutine */
                                                        ...
                                                        */
                                                        ...
                                                        pKeyInfo = keyInfoFromExprList(pParse,
                                                            pGroupBy);
                                                        addrSortingIdx = sqlite3VdbeAddOp4(v,
                                                            OP_OpenEphemeral,
                                                            sAggInfo.sortingIdx,
                                                            sAggInfo.nSortingColumn,
                                              ...
                                              */
                                                        sqlite3VdbeAddOp2(v, OP_Gosub, regReset,
                                                            addrReset);
                                                        pWInfo = sqlite3WhereBegin(pParse, pTabList,
                                                            pWhere, ref pGroupBy, 0);
                                                        if (pWInfo == null)
                                                            goto select_end;
                                                        if (pGroupBy == null)
                                                        {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            */
                                                            ...
                                                            sqlite3ExprCodeExprList(pParse, pGroupBy,
                                                                regBase, false);
                                                            sqlite3VdbeAddOp2(v, OP_Sequence,
                                                                sAggInfo.sortingIdx,
                                                                regBase + nGroupBy);
                                                            j = nGroupBy + 1;
                                                            for (i = 0; i < sAggInfo.nColumn; i++)
                                                            ...
                                                            sqlite3VdbeAddOp2(v, OP_IdxInsert,
                                                                sAggInfo.sortingIdx, regRecord);
                                                            sqlite3ReleaseTempReg(pParse, regRecord);
                                                            sqlite3ReleaseTempRange(pParse, regBase,
                                                                nCol);
                                                            sqlite3WhereEnd(pWInfo);
                                                            sqlite3VdbeAddOp2(v, OP_Sort,
                                                        ...
                                                        */
                                                        ...
                                                        for (j = 0; j < pGroupBy.nExpr; j++)
                                                            if (groupBySort != 0)
                                                            {
                                                                sqlite3VdbeAddOp3(v, OP_Column,
                                                                    sAggInfo.sortingIdx, j, iBMem + j);
                                                            }
                                                            else
                                                            {
                                                                sAggInfo.directMode = 1;
                                                                sqlite3ExprCode(pParse,
                                                                    pGroupBy.a[j].pExpr, iBMem + j);
                                                            }
                                                        ...
                                                        sqlite3VdbeAddOp3(v, OP_Jump, j1 + 1, 0,
                                                            j1 + 1);
...
#endif
                                                        sqlite3VdbeAddOp2(v, OP_IfPos, iAbortFlag,
                                                            addrEnd);
#if SQLITE_DEBUG
                                              ...
                                              */
                                                        if (groupBySort != 0)
                                                        {
                                                            sqlite3VdbeAddOp2(v, OP_Next,
                                                                sAggInfo.sortingIdx, addrTopOfLoop);
                                                        }
                                                        else
                                                        {
                                                            sqlite3WhereEnd(pWInfo);
                                              ...
                                              */
                                                        ...
                                                        */
                                                        ...
                                                        sqlite3ExprIfFalse(pParse, pHaving,
                                                            addrOutputRow + 1, SQLITE_JUMPIFNULL);
                                                        selectInnerLoop(pParse, p, p.pEList, 0, 0,
                                                            pOrderBy,
                                                            distinct, pDest,
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        if ((pTab = isSimpleCount(p, sAggInfo)) != null)
                                                        {
                                                            ...
                                                            */
                                                            var iDb = sqlite3SchemaToIndex(pParse.db,
                                                                pTab.pSchema);
                                                            var iCsr = pParse
                                                                .nTab++; /* Cursor to scan b-tree */
                                                            Index pIdx; /* Iterator variable */
                                                            KeyInfo pKeyInfo =
                                                                null; /* Keyinfo for scanned index */
                                                            Index pBest =
                                                                null; /* Best index found so far */
                                                            var iRoot = pTab
                                                                .tnum; /* Root page of scanned b-tree */
                                                            ...
                                                            */
                                                            ...
                                                            {
                                                                iRoot = pBest.tnum;
                                                                pKeyInfo = sqlite3IndexKeyinfo(pParse,
                                                                    pBest);
                                                            }

                                                            /* Open a read-only cursor, execute the OP_Count, close the cursor. */
                                                            sqlite3VdbeAddOp3(v, OP_OpenRead, iCsr,
                                                                iRoot, iDb);
                                                            if (pKeyInfo != null)
                                                                sqlite3VdbeChangeP4(v, -1, pKeyInfo,
                                                                    P4_KEYINFO_HANDOFF);
                                                            ...
                                                            if (flag != 0)
                                                            {
                                                                Debug.Assert(
                                                                    !ExprHasProperty(
                                                                        p.pEList.a[0].pExpr,
                                                                        EP_xIsSelect));
                                                                pMinMax = sqlite3ExprListDup(db,
                                                                    p.pEList.a[0].pExpr.x.pList, 0);
                                                                pDel = pMinMax;
                                                                if (pMinMax !=
                                                                    null) ///* && 0 == db.mallocFailed */ )
                                                                {
                                                                    pMinMax.a[0].sortOrder =
                                                                        (byte)(flag != WHERE_ORDERBY_MIN
                                                                            ? 1
                                                                            : 0);
                                                        ...
                                                        sqlite3ExprIfFalse(pParse, pHaving, addrEnd,
                                                            SQLITE_JUMPIFNULL);
                                                        selectInnerLoop(pParse, p, p.pEList, 0, 0, null,
                                                            -1,
                                                ...
                                                if (distinct >= 0) explainTempTable(pParse, "DISTINCT");
                                        ...
                                        */
                                            ...
                                            private void sqlite3PrintExprList(ExprList pList)
                                            {
                                                ...
                                                for (i = 0; i < pList.nExpr; i++)
                                                {
                                                    ...
                                                    if (i < pList.nExpr - 1) sqlite3DebugPrintf(", ");
                                                }
                                            }
                                            ...
                                            private void sqlite3PrintSelect(Select p, int indent)
                                            {
                                                ...
                                                if (p.pSrc != null)
                                                {
                                                    ...
                                                    for (i = 0; i < p.pSrc.nSrc; i++)
                                                    {
                                                        ...
                                                        {
                                                            sqlite3DebugPrintf("(\n");
                                                            sqlite3PrintSelect(pItem.pSelect,
                                                                indent + 10);
