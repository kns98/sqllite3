...
*/
        ...
        )
        {
            ...
            */
            ...
            rc = sqlite3BtreeOpen(pVfs, zPath, db, ref aNew.pBt, 0, flags);
            //sqlite3_free( zPath );
            ...
            if (rc == SQLITE_OK)
            {
                ...
                int nKey;
                string zKey;
                var t = sqlite3_value_type(argv[2]);
                switch (t)
                {
                    case SQLITE_INTEGER:
                    case SQLITE_FLOAT:
...
*/
        ...
        )
        {
            ...
            int i;
            Db pDb = null;
            var zErr = new StringBuilder(200);
...
goto attach_end;
            ...
            if (v != null)
            {
                ...
                sqlite3VdbeChangeP5(v, (byte)pFunc.nArg);
...
**     DETACH pDbname
*/
        private static readonly FuncDef detach_func = new FuncDef(
            1, /* nArg */
...
*/
        private static readonly FuncDef attach_func = new FuncDef(
            3, /* nArg */
            SQLITE_UTF8, /* iPrefEnc */
            0, /* flags */
            null, /* pUserData */
