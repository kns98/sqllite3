    ...
    */
        ...
        */
        public static int sqlite3_clear_bindings(sqlite3_stmt pStmt)
        {
            ...
            if (p.isPrepareV2 && p.expmask != 0) p.expired = true;
            sqlite3_mutex_leave(mutex);
            return rc;
        }
            ...
            if ((p.flags & (MEM_Blob | MEM_Str)) != 0)
            {
                ...
                if (p.zBLOB == null && p.z != null)
                {
                    ...
                    else
                    {
                        ...
                        for (var i = 0; i < p.zBLOB.Length; i++)
                ...
                p.flags = (ushort)(p.flags & ~MEM_Str);
                p.flags |= MEM_Blob;
...
return sqlite3ValueText(pVal, SQLITE_UTF16LE);
        ...
        */
        ...
        {
            if (sqlite3VdbeMemSetStr(pCtx.s, z, o, n, enc, xDel) == SQLITE_TOOBIG) sqlite3_result_error_toobig(pCtx);
        }
...
return SQLITE_MISUSE_BKPT();
            ...
            if (p.pc < 0)
            {
                ...
                */
                ...
                if (db.xProfile != null && 0 == db.init.busy) sqlite3OsCurrentTimeInt64(db.pVfs, ref p.startTime);
#endif
      ...
      */
            ...
            if (rc == SQLITE_DONE)
            {
                ...
                if (p.rc != SQLITE_OK) rc = SQLITE_ERROR;
            }
...
//# define SQLITE_MAX_SCHEMA_RETRY 5
        ...
        */
        ...
        {
            var rc = SQLITE_OK; /* Result from sqlite3Step() */
            var rc2 = SQLITE_OK; /* Result from sqlite3Reprepare() */
            var v = pStmt; /* the prepared statement */
            var cnt = 0; /* Counter to prevent infinite loop of reprepares */
            sqlite3 db; /* The database connection */

            if (vdbeSafetyNotNull(v)) return SQLITE_MISUSE_BKPT();
            db = v.db;
        ...
        */
        ...
        )
        {
            ...
            if (pAuxData.pAux != null && pAuxData.pAux is IDisposable) (pAuxData.pAux as IDisposable).Dispose();
            pAuxData.pAux = pAux;
            return;

            failed:
            if (pAux != null && pAux is IDisposable) (pAux as IDisposable).Dispose();
        }
    ...
    */
        ...
        private static Mem columnMem(sqlite3_stmt pStmt, int i)
        {
            ...
            else
            {
                ...
                ** __attribute__((aligned(8))) macro.  */
                ...
                //#endif
                //         0, 0 };
                var nullMem = new Mem(null, "", 0, 0, 0, MEM_Null, SQLITE_NULL, 0
#if SQLITE_DEBUG
        ...
        */
        ...
        public static sqlite3_value sqlite3_column_value(sqlite3_stmt pStmt, int i)
        {
            ...
            {
                pOut.flags = (ushort)(pOut.flags & ~MEM_Static);
...
pStmt, N, (const void*()(Mem))sqlite3_value_text16, COLNAME_COLUMN);
    ...
    */
        ...
        */
        ...
        {
            Mem pVar;
            if (vdbeSafetyNotNull(p)) return SQLITE_MISUSE_BKPT();
            ...
            */
            if (p.isPrepareV2 &&
                ((i < 32 && (p.expmask != 0) & ((uint)1 << i != 0)) || p.expmask == 0xffffffff)
               )
                p.expired = true;
...
return bindText(pStmt, i, zData, nData, xDel, SQLITE_UTF16NATIVE);
        ...
        */
        ...
        {
            var p = pStmt;
            if (p == null || i < 1 || i > p.nzVar) return "";
            return p.azVar[i - 1];
        }
...
return sqlite3TransferBindings( pFromStmt, pToStmt );
    ...
    */
        ...
        */
        ...
        {
            return pStmt != null ? pStmt.readOnly : true;
        }
