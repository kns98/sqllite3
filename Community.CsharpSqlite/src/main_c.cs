      ...
      */
            ...
            */
            ...
            lock (pMaster)
            {
                ...
                if (sqlite3GlobalConfig.isMallocInit == 0) rc = sqlite3MallocInit();
                if (rc == SQLITE_OK)
                {
...
memset( pHash, 0, sizeof( sqlite3GlobalFunctions ) );
                    ...
                    if (sqlite3GlobalConfig.isPCacheInit == 0) rc = sqlite3PcacheInitialize();
                    if (rc == SQLITE_OK)
                    {
        ...
        */
        ...
        private static int sqlite3_config(int op, sqlite3_mutex_methods ap)
        {
            //  va_list ap;
            var rc = SQLITE_OK;
            switch (op)
        ...
        private static int sqlite3_config(int op, ref sqlite3_mutex_methods ap)
        {
            //  va_list ap;
            var rc = SQLITE_OK;
            switch (op)
                ...
                switch (op)
                {
                    ...
                    */
                    ...
                    case SQLITE_CONFIG_MEMSTATUS:
                    {
                        ...
                        sqlite3GlobalConfig.bMemstat = va_arg(ap, 0) != 0;
                        break;
                    }
                    case SQLITE_CONFIG_SCRATCH:
                    {
                        ...
                        sqlite3GlobalConfig.szScratch = va_arg(ap, 0);
                        sqlite3GlobalConfig.nScratch = va_arg(ap, 0);
                        break;
                    }
                    ...
                    case SQLITE_CONFIG_PAGECACHE:
                    {
                        ...
                        sqlite3GlobalConfig.szPage = va_arg(ap, 0);
                        sqlite3GlobalConfig.nPage = va_arg(ap, 0);
                        break;
                    }
...
break;
                    ...
                    {
                        sqlite3GlobalConfig.szLookaside = va_arg(ap, 0);
                        sqlite3GlobalConfig.nLookaside = va_arg(ap, 0);
                        break;
                    }
                    ...
                    */
                    ...
                    {
                        sqlite3GlobalConfig.bOpenUri = va_arg(ap, true);
                        break;
                    }
                    default:
                    {
        ...
        */
        ...
        {
            public uint mask; /* Mask of the bit in sqlite3.flags to set/clear */
        ...
        private static int sqlite3_db_config(sqlite3 db, int op, params object[] ap)
        {
            ...
            lock (lock_va_list)
            {
                ...
                switch (op)
                {
                    ...
                    {
                        var pBuf = va_arg(ap, (byte[])null); /* IMP: R-26835-10964 */
                        var sz = va_arg(ap, 0); /* IMP: R-47871-25994 */
                        var cnt = va_arg(ap, 0); /* IMP: R-04460-53386 */
                    ...
                    default:
                    {
                        ...
                        for (i = 0; i < ArraySize(aFlagOp); i++)
                            if (aFlagOp[i].op == op)
                            {
                                var onoff = va_arg(ap, 0);
                                var pRes = va_arg(ap, 0);
                                var oldFlags = db.flags;
                                if (onoff > 0)
                                    db.flags = (int)((uint)db.flags | aFlagOp[i].mask);
                                else if (onoff == 0) db.flags = (int)(db.flags & ~aFlagOp[i].mask);
                                if (oldFlags != db.flags) sqlite3ExpirePreparedStatements(db);
                                if (pRes != 0) pRes = (db.flags & aFlagOp[i].mask) != 0 ? 1 : 0;
                                rc = SQLITE_OK;
                                break;
                            }
        ...
        */
        public static int sqlite3_close(sqlite3 db)
        {
            ...
            if (!sqlite3SafetyCheckSickOrOk(db)) return SQLITE_MISUSE_BKPT();
            ...
            */
            ...
            {
                var pMod = (Module)sqliteHashData(i);
                if (pMod.xDestroy != null) pMod.xDestroy(ref pMod.pAux);
...
/* SQLITE_NOTADB      */ "file is encrypted or is not a database"
        ...
        */
        ...
        )
        {
            ...
            byte[] delays = { 1, 2, 5, 10, 15, 20, 25, 25, 25, 50, 50, 100 };
            byte[] totals = { 0, 1, 3, 8, 18, 33, 53, 78, 103, 128, 178, 228 };
            //# define NDELAY ArraySize(delays)
            var NDELAY = ArraySize(delays);
            var db = (sqlite3)ptr;
...
enc = SQLITE_UTF16BE;
      ...
      */
            ...
            ** being replaced invoke the destructor function here. */
            ...
            if (pDestructor != null) pDestructor.nRef++;
        ...
        )
        {
            ...
            if (sqlite3FindFunction(db, zName, nName, nArg, SQLITE_UTF8, 0) == null)
                sqlite3CreateFunc(db, zName, nArg, SQLITE_UTF8,
                    0, sqlite3InvalidFunction, null, null, null);
  ...
  return (rc==SQLITE_OK && bBusy) ? SQLITE_BUSY : rc;
        ...
        */
        public static string sqlite3_errmsg(sqlite3 db)
        {
            ...
            if (!sqlite3SafetyCheckSickOrOk(db)) return sqlite3ErrStr(SQLITE_MISUSE_BKPT());
            sqlite3_mutex_enter(db.mutex);
...
return z;
    ...
    */
        ...
        {
            if (db != null && !sqlite3SafetyCheckSickOrOk(db)) return SQLITE_MISUSE_BKPT();
        ...
        */
        ...
        )
        {
            ...
            */
            ...
            if (enc2 < SQLITE_UTF8 || enc2 > SQLITE_UTF16BE) return SQLITE_MISUSE_BKPT();

            /* Check if this call is removing or replacing an existing collation
            ** sequence. If so, and there are active VMs, return busy. If there
            ** are no active VMs, invalidate any pre-compiled statements.
            */
            pColl = sqlite3FindCollSeq(db, (byte)enc2, zName, 0);
            if (pColl != null && pColl.xCmp != null)
            {
                ...
                */
                ...
                {
                    var aColl = sqlite3HashFind(db.aCollSeq, zName, nName, (CollSeq[])null);
                    int j;
                    for (j = 0; j < 3; j++)
                    {
                        var p = aColl[j];
            ...
            pColl = sqlite3FindCollSeq(db, (byte)enc2, zName, 1);
            //if ( pColl == null )
            //  return SQLITE_NOMEM;
            pColl.xCmp = xCompare;
            pColl.pUser = pCtx;
        ...
        */
        private static int sqlite3_limit(sqlite3 db, int limitId, int newLimit)
        {
            ...
            */
            ...
            {
                if (newLimit > aHardLimit[limitId]) newLimit = aHardLimit[limitId]; /* IMP: R-51463-25634 */
    ...
    */
        ...
        )
        {
            var rc = SQLITE_OK;
            var flags = pFlags;
            var zVfs = zDefaultVfs;
            StringBuilder zFile = null;
            char c;
            var nUri = sqlite3Strlen30(zUri);
            pzErrMsg = null;
            ppVfs = null;
               ...
               )
            {
                ...
                var nByte = nUri + 2; /* Bytes of space to allocate */
                ...
                ** method that there may be extra parameters following the file-name.  */
                ...
                if (zUri[5] == '/' && zUri[6] == '/')
                {
                    ...
                    if (iIn != 7 && (iIn != 16 || string.Compare("localhost", zUri.Substring(7, 9),
                            StringComparison.InvariantCultureIgnoreCase) != 0)) //memcmp("localhost", &zUri[7], 9)) )
                    {
                ...
                */
                ...
                while (iIn < nUri && (c = zUri[iIn]) != 0 && c != '#')
                {
                    ...
                    {
                        var octet = sqlite3HexToInt(zUri[iIn++]) << 4;
                ...
                ** method. */
                ...
                while (zOpt.Length > 0)
                {
                    var nOpt = sqlite3Strlen30(zOpt);
                    var zVal = zOpt.Substring(nOpt); //zOpt[nOpt + 1];
                    var nVal = sqlite3Strlen30(zVal);
        ...
        */
        ...
        )
        {
            ...
            var zOpen = ""; /* Filename argument to pass to BtreeOpen() */
            var zErrMsg = ""; /* Error message from sqlite3ParseUri() */
      ...
      */
            ...
            else if (sqlite3GlobalConfig.sharedCacheEnabled) flags |= SQLITE_OPEN_SHAREDCACHE;
...
return sqlite3ApiExit(0, rc);
    ...
    */
        ...
        )
        {
            ...
            sqlite3_mutex_enter(db.mutex);
            //Debug.Assert( 0 == db.mallocFailed );
            rc = createCollation(db, zName, (byte)enc, SQLITE_COLL_USER, pCtx, xCompare, null);
            rc = sqlite3ApiExit(db, rc);
            sqlite3_mutex_leave(db.mutex);
            return rc;
        }
        ...
        */
        ...
        )
        {
            ...
            sqlite3_mutex_enter(db.mutex);
            //Debug.Assert( 0 == db.mallocFailed );
            rc = createCollation(db, zName, (byte)enc, SQLITE_COLL_USER, pCtx, xCompare, xDel);
            rc = sqlite3ApiExit(db, rc);
            sqlite3_mutex_leave(db.mutex);
            return rc;
        }
...
error_out:
    ...
    */
        ...
        */
        private static int sqlite3_file_control(sqlite3 db, string zDbName, int op, ref long pArg)
        {
            var rc = SQLITE_ERROR;
            int iDb;
            sqlite3_mutex_enter(db.mutex);
                ...
                switch (op)
                {
                  ...
                  TCLsqlite3PendingByte.iValue = sqlite3PendingByte;
                    ...
                    */
                    ...
                    {
                        var db = va_arg(ap, (sqlite3)null); //sqlite3 db = va_arg(ap, sqlite3);
                        var x = va_arg(ap, 0); //int x = va_arg(ap,int);
                    ...
                    */
                    ...
                    {
                        var zWord = va_arg(ap, "char*");
                        var n = sqlite3Strlen30(zWord);
                    ...
                    */
                    ...
                    {
                        sqlite3GlobalConfig.bLocaltimeFault = va_arg(ap, true);
                        break;
                    }
                }
