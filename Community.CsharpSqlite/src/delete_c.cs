          ...
          */
            {
                ...
                ** triggers.  */
                if (!isView) sqlite3OpenTableAndIndices(pParse, pTab, iCur, OP_OpenWrite);
...
#endif
                {
                    var count = pParse.nested == 0 ? 1 : 0; /* True to count changes */
...
sqlite3AuthContextPop(sContext);
        ...
        */
        ...
        {
            var v = pParse.pVdbe; /* Vdbe */
            var iOld = 0; /* First register in OLD.* array */
            ...
            ** use for the old.* references in the triggers.  */
            ...
            {
                uint mask; /* Mask of OLD.* columns in use */
            ...
            ** fire the INSTEAD OF triggers).  */
            if (pTab.pSelect == null)
            {
                ...
                if (count != 0) sqlite3VdbeChangeP4(v, -1, pTab.zName, P4_TRANSIENT);
            }
