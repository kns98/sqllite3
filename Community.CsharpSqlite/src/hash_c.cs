...
namespace Community.CsharpSqlite
{
    public partial class Sqlite3
    {
        ...
        */
        private static bool rehash(ref Hash pH, uint new_size)
        {
      ...
      */
        ...
        */
        private static void removeElementGivenHash(
            ...
            uint h /* Hash value for the element */
        )
        {
            _ht pEntry;
            if (elem.prev != null)
        ...
        */
        ...
        {
            uint h; /* the hash of the key modulo hash table size */
