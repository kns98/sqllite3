...
namespace Community.CsharpSqlite
{
    public partial class Sqlite3
    {
        ...
        */
        ...
        /*   INITIALLY                                                          */
        private static readonly string zText = new string(new char[540]
        {
...
'\0',
        ...
        private static readonly byte[] aHash =
        {
            //aHash[127]
        ...
        private static readonly byte[] aNext =
        {
            //aNext[121]
        ...
        private static readonly byte[] aLen =
        {
            //aLen[121]
        ...
        private static readonly int[] aOffset =
        {
            //aOffset[121]
        ...
        private static readonly byte[] aCode =
        {
            //aCode[121
        ...
        private static int keywordCode(string z, int iOffset, int n)
        {
            ...
            for (i = aHash[h] - 1; i >= 0; i = aNext[i] - 1)
                if (aLen[i] == n && string.Compare(zText, aOffset[i], z, iOffset, n,
