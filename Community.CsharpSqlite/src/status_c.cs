...
//# define wsdStat x[0]
    ...
    */
        ...
        */
        ...
        {
            wsdStatInit();
            if (op < 0 || op >= ArraySize(wsdStat.nowValue)) return SQLITE_MISUSE_BKPT();
        ...
        )
        {
            ...
            switch (op)
            {
                ...
                case SQLITE_DBSTATUS_LOOKASIDE_MISS_FULL:
                {
                    ...
                    if (resetFlag != 0) db.lookaside.anStat[op - SQLITE_DBSTATUS_LOOKASIDE_HIT] = 0;
                    break;
                }
                ...
                */
                case SQLITE_DBSTATUS_CACHE_USED:
                {
                    ...
                    for (i = 0; i < db.nDb; i++)
                    {
                        ...
                        if (pBt != null)
                        {
                            var pPager = sqlite3BtreePager(pBt);
                ...
                */
                case SQLITE_DBSTATUS_SCHEMA_USED:
                {
                    ...
                    var nByte = 0; /* Used to accumulate return value */
                ...
                */
                case SQLITE_DBSTATUS_STMT_USED:
                {
                    ...
                    //db.pnBytesFreed = nByte;
                    for (pVdbe = db.pVdbe; pVdbe != null; pVdbe = pVdbe.pNext) sqlite3VdbeDeleteObject(db, ref pVdbe);
                    db.pnBytesFreed = 0;
