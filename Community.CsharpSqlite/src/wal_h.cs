...
namespace Community.CsharpSqlite
{
    public partial class Sqlite3
    {
        ...
        */
        ...
        private static int sqlite3WalRead(object v, uint w, ref int x, int y, byte[] z)
        {
            return 0;
        }

        //# define sqlite3WalDbsize(y) 0
        private static uint sqlite3WalDbsize(object y)
        {
            return 0;
        }
        ...
        private static int sqlite3WalFrames(object u, int v, PgHdr w, uint x, int y, int z)
        {
            return 0;
        }

        //# define sqlite3WalCheckpoint(r,s,t,u,v,w,x,y,z)         0
        private static int sqlite3WalCheckpoint(object r, int s, int t, byte[] u, int v, int w, byte[] x, ref int y,
