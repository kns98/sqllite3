...
namespace Community.CsharpSqlite
{
    ...
    */
        ...
        */
        public class BtLock
        {
            private byte eLock; /* READ_LOCK or WRITE_LOCK */
        ...
        */
        public class Btree
        {
            ...
            public byte inTrans; /* TRANS_NONE, TRANS_READ or TRANS_WRITE */
...
public u8 isPending;            /* If waiting for read-locks to clear */
        ...
        */
        ...
        public struct CellInfo
        {
            ...
            {
                if (ci.iCell >= ci.pCell.Length || iCell >= pCell.Length)
                    return false;
                if (ci.pCell[ci.iCell] != pCell[iCell])
                    return false;
                if (ci.nKey != nKey || ci.nData != nData || ci.nPayload != nPayload)
                    return false;
        ...
        */
        public class BtCursor
        {
            ...
            public CellInfo info; /* A parse of the cell we are pointing at */
...
aOverflow = null;
        ...
        */
        ...
        private static uint PTRMAP_PTROFFSET(uint pgptrmap, uint pgno)
        {
