...
** aXRef[i]==-1 if the i-th column is not changed. */
            ...
            var tmask = 0; /* Mask of TRIGGER_BEFORE|TRIGGER_AFTER */
#endif
...
//    # undef isView
      const bool isView = false;    //# define isView 0
            ...
            if (sqlite3IsReadOnly(pParse, pTab, tmask)) goto update_cleanup;
...
aXRef[j] = -1;
            ...
            */
            ...
            if (chngRowid || pTrigger != null || hasFK) regNewRowid = ++pParse.nMem;
            regNew = pParse.nMem + 1;
            pParse.nMem += pTab.nCol;

            /* Start the view context. */
            if (isView) sqlite3AuthContextPush(pParse, sContext, pTab.zName);
      ...
      */
            ...
            ** with the required old.* column data.  */
            ...
            {
                var oldmask = hasFK ? sqlite3FkOldmask(pParse, pTab) : 0;
                ...
                if (chngRowid == false) sqlite3VdbeAddOp2(v, OP_Copy, regOldRowid, regNewRowid);
            }
            ...
            */
            ...
            if (!isView)
            {
                ...
                if (hasFK) sqlite3FkCheck(pParse, pTab, regOldRowid, 0);
                ...
                if (hasFK || chngRowid) sqlite3VdbeAddOp2(v, OP_Delete, iCur, 0);
                sqlite3VdbeJumpHere(v, j1);

                if (hasFK) sqlite3FkCheck(pParse, pTab, 0, regNewRowid);
                ...
                ** to the row just updated. */
                if (hasFK) sqlite3FkActions(pParse, pTab, pChanges, regOldRowid);
            }
...
sqlite3AuthContextPop(sContext);
    ...
    */
        ...
        {
            var v = pParse.pVdbe; /* Virtual machine under construction */
            ...
            var pVTab = sqlite3GetVTable(db, pTab);
