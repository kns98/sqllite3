...
namespace Community.CsharpSqlite
{
    ...
    public partial class Sqlite3
    {
        ...
        */
        ...
        private static readonly StringBuilder zdtTemp = new StringBuilder(100);
        private static readonly StringBuilder zdtBuf = new StringBuilder(100);
...
//} while ( nextC != 0 && zIndex < zDate.Length );
        ...
        */
        ...
        )
        {
            ...
            if (sqlite3AtoF(zDate, ref r, sqlite3Strlen30(zDate), SQLITE_UTF8))
            {
        ...
        */
        private static int osLocaltime(long t, tm pTm)
        {
            ...
            tm pX;
            var mutex = sqlite3MutexAlloc(SQLITE_MUTEX_STATIC_MASTER);
  ...
  rc = localtime_s(pTm, t);
    ...
    */
        ...
        )
        {
            ...
            x.validJD = 0;
            computeJD(x);
            t = x.iJD / 1000 - 210866760000L; // (time_t)(x.iJD/1000 - 21086676*(i64)10000);
    ...
    */
...
#if !SQLITE_OMIT_LOCALTIME
            {
                ...
                case '9':
                {
                    ...
                    else if (n == 4 && z.ToString() == "year")
                    {
                        ...
                        p.validJD = 0;
                        computeJD(p);
                        if (y != r) p.iJD += (long)((r - y) * 365.0 * 86400000.0 + rRounder);
                    }
                    else
                    {
                        rc = 1;
        ...
        */
        ...
        )
        {
            ...
            if (isDate(context, argc, argv, ref x) == 0)
            {
                var zdtBuf = new StringBuilder(100);
                computeYMD(x);
        ...
        {
            {
                ...
                for (i = 0; i < argc - 1; i++) argv[i + 1].CopyTo(ref argv1[i]);
                ...
                testcase(n == (ulong)(zdtBuf.Length - 1));
                testcase(n == (ulong)zdtBuf.Length);
                testcase(n == (ulong)db.aLimit[SQLITE_LIMIT_LENGTH] + 1);
                testcase(n == (ulong)db.aLimit[SQLITE_LIMIT_LENGTH]);
                if (n < (ulong)zdtBuf.Capacity)
                {
                    z = zdtBuf;
                }
                else if (n > (ulong)db.aLimit[SQLITE_LIMIT_LENGTH])
                {
                        ...
                        switch (zFmt[i])
                        {
                            ...
                            case 's':
                            {
                                sqlite3_snprintf(30, zdtTemp, "%lld",
                                    x.iJD / 1000 - 21086676 * (long)10000);
                                z.Append(zdtTemp);
                                j = sqlite3Strlen30(z);
                                break;
                            }
