        ...
        private static int sqlite3MutexInit()
        {
            ...
            if (null == sqlite3GlobalConfig.mutex.xMutexAlloc)
            {
                ...
                */
                ...
                var pTo = sqlite3GlobalConfig.mutex;
...
*/
        ...
        {
            var rc = SQLITE_OK;
            if (sqlite3GlobalConfig.mutex.xMutexEnd != null) rc = sqlite3GlobalConfig.mutex.xMutexEnd();
...
*/
        ...
        {
            if (!sqlite3GlobalConfig.bCoreMutex) return null;
...
*/
        ...
        {
            if (p != null) sqlite3GlobalConfig.mutex.xMutexFree(p);
        }
...
*/
        ...
        {
            if (p != null) sqlite3GlobalConfig.mutex.xMutexEnter(p);
        }
...
*/
        ...
        {
            var rc = SQLITE_OK;
            if (p != null) return sqlite3GlobalConfig.mutex.xMutexTry(p);
            return rc;
        }
...
*/
        ...
        {
            if (p != null) sqlite3GlobalConfig.mutex.xMutexLeave(p);
        }
