...
expensive_assert( pcacheCheckSynced(p) );
        ...
        */
        private static int sqlite3PcacheFetch(
            ...
            uint pgno, /* Page number to obtain */
...
expensive_assert( pcacheCheckSynced(pCache) );
      ...
      sqlite3_log(SQLITE_FULL, 
        ...
        */
        private static void sqlite3PcacheMove(PgHdr p, uint newPgno)
        {
            var pCache = p.pCache;
            Debug.Assert(p.nRef > 0);
    ...
    static int sqlite3PcacheGetCachesize( PCache pCache )
    {
      return pCache.nMax;
                ...
                */
                    ...
                    {
                        PgHdr pDirty;
                        for (pDirty = pCache.pDirty; pDirty != null; pDirty = pDirty.pDirtyNext) xIter(pDirty);
                    }
#endif
                    }
                    }