...
const int SQLITE_DEFAULT_MEMSTATUS = 1;
    ...
    */
        ...
        private const int
            _XOPEN_SOURCE = 500; //#define _XOPEN_SOURCE 500  /* Needed to enable pthread recursive mutexes */
#endif
...
#endif
#if !SQLITE_BIG_DBL
        private const double SQLITE_BIG_DBL = (long)1 << 60; //# define SQLITE_BIG_DBL (1e99)
#endif
...
const int ;//#define SQLITE_UTF16NATIVE  SQLITE_UTF16LE
#else
        private static readonly byte SQLITE_BIGENDIAN = 0; //#define SQLITE_BIGENDIAN    (*(char )(&sqlite3one)==0)
    ...
    */
        ...
        private const long LARGEST_INT64 = long.MaxValue; //( 0xffffffff | ( ( (i64)0x7fffffff ) << 32 ) );
        private const long SMALLEST_INT64 = long.MinValue; //( ( ( i64 ) - 1 ) - LARGEST_INT64 );
    ...
    */
        ...
        */
        public class Schema
        {
            ...
            public uint iGeneration; /* Generation counter.  Incremented with each change */
        ...
        */
        ...
        private const ushort DB_SchemaLoaded = 0x0001;
        private const ushort DB_UnresetViews = 0x0002;
        private const ushort DB_Empty = 0x0004;
        ...
        */
        public class Lookaside
        {
            ...
            public byte bEnabled; /* False to disable new lookaside allocations */
        ...
        */
        public class sqlite3
        {
            ...
            public uint magic; /* Magic number for detect library misuse */
            ...
            {
                public byte busy; /* TRUE if currently initializing */ /* Information used during initialization */
...
public object pAuthArg;               /* 1st argument to the access auth function */
            ...
            public long nDeferredCons; /* Net deferred constraints this transaction. */
...
sqlite3 *pNextBlocked;        /* Next in list of all blocked connections */
        ...
        */
        ...
        {
            return new FuncDef(zName, SQLITE_UTF8, nArg, iArg, (byte)(bNC * SQLITE_FUNC_NEEDCOLL), xFunc);
        }
        ...
        {
            return new FuncDef(zName, SQLITE_UTF8, nArg, arg, (byte)(nc * SQLITE_FUNC_NEEDCOLL), xStep, xFinal);
        }
...
#if !SQLITE_OMIT_VIRTUALTABLE
            public byte isHidden; /* True if this column is 'hidden' */
#endif
            public byte isPrimKey; /* True if this column is part of the PRIMARY KEY */
            public byte notNull; /* True if there is a NOT NULL constraint */
        ...
        */
        public class CollSeq
        {
            ...
            public byte type; /* One of the SQLITE_COLL_... values below */
        ...
        */
        public class VTable
        {
            public byte bConstraint; /* True if constraints are supported */
        ...
        */
        public class Table
        {
            ...
            public ushort nRef; /* Number of pointers to this Table */
            public uint nRowEst; /* Estimated rows in table - from sqlite_stat1 table */
...
//#  define IsVirtual(X)      (((X)->tabFlags & TF_Virtual)!=0)
    ...
    */
        public class FKey
        {
            public byte[] aAction = new byte[2]; /* ON DELETE and ON UPDATE actions, respectively */
            ...
            /* EV: R-30323-21917 */
            public byte isDeferred; /* True if constraint checking is deferred till COMMIT */
        ...
        */
        public class Index
        {
            ...
            public byte[] aSortOrder; /* Array of size Index.nColumn. True==DESC, False==ASC */
            public byte autoIndex; /* True if is automatically created (ex: by UNIQUE) */
            public string[] azColl; /* Array of collation sequence names for index */
            public byte bUnordered; /* Use this index for == or IN queries only */
        ...
        */
        ...
        {
            public byte eType; /* SQLITE_NULL, SQLITE_INTEGER ... etc. */
            public byte nByte; /* Size in byte of text or blob. */
            public _u u;
...
set { _n = value; }
        ...
        */
        ...
        public class AggInfo
        {
            ...
            public byte directMode; /* Direct rendering mode means take data directly
...
** aggregate functions */
            ...
            public byte useSortingIdx; /* In direct mode, reference the sorting index rather
...
public int iValue;            /* Non-negative integer value if EP_IntValue */
            ...
            public ushort flags; /* Various flags.  EP_* See below */
#endif
            public _u u;
  ...
  ** TK_TRIGGER: 1 -> new, 0 -> old */
            ...
            public short iColumn; /* TK_COLUMN: column index.  -1 for rowid.
...
set { _op = value; }
        ...
        */
        ...
        private const byte EP2_MallocedToken = 0x0001;
        private const byte EP2_Irreducible = 0x0002;
...
static void ExprSetIrreducible( Expr X ) { }
    ...
    */
        ...
        */
        ...
        private const int BMS = sizeof(ulong) * 8;
        ...
        */
        ...
        {
            public uint nEq; /* Number of == constraints */
        ...
        */
        public class WhereInfo
        {
            ...
            public byte okOnePass; /* Ok to use one-pass algorithm for UPDATE or DELETE */
            ...
            public ushort wctrlFlags; /* Flags originally passed to sqlite3WhereBegin() */
        }
        ...
        */
        ...
        {
            public byte allowAgg; /* Aggregate functions allowed here */
            public byte hasAgg; /* True if aggregates are seen */
            public byte isCheck; /* True if resolving names in a CHECK constraint */
    ...
    */
        ...
        {
            public uint[] aColmask = new uint[2]; /* Masks of old.*, new.* columns accessed */
        ...
        */
        ...
        public class Parse
        {
            ...
            public int writeMask; /* Start a write transaction on these databases */
            public int cookieMask; /* Bitmask of schema verified databases */
...
the <column-list> is stored here */
        ...
        */
        ...
        {
            public byte op; /* One of TK_DELETE, TK_UPDATE, TK_INSERT, TK_SELECT */
        ...
        */
        public class StrAccum
        {
            ...
            public long nChar => zText.Length;

            public bool tooBig => mxAlloc > 0 && zText.Length > mxAlloc;
        }
