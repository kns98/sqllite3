...
namespace Community.CsharpSqlite
{
    public partial class Sqlite3
    {
        ...
        */
        ...
        private const string SQLITE_SOURCE_ID =
        ...
        */
        ...
        public class sqlite3_vfs
        {
            ...
            ** value will increment whenever this happens. */
            ...
            {
                ct.iVersion = iVersion;
                ct.szOsFile = szOsFile;
                ct.mxPathname = mxPathname;
                ct.pNext = pNext;
                ct.zName = zName;
                ct.pAppData = pAppData;
                ct.xOpen = xOpen;
                ct.xDelete = xDelete;
                ct.xAccess = xAccess;
                ct.xFullPathname = xFullPathname;
                ct.xDlOpen = xDlOpen;
                ct.xDlError = xDlError;
                ct.xDlSym = xDlSym;
                ct.xDlClose = xDlClose;
                ct.xRandomness = xRandomness;
                ct.xSleep = xSleep;
                ct.xCurrentTime = xCurrentTime;
                ct.xGetLastError = xGetLastError;
                ct.xCurrentTimeInt64 = xCurrentTimeInt64;
            }
        }
...
//Copy sqlite3_mutex_methods from existing 
            public void Copy(sqlite3_mutex_methods cp)
            {
                ...
                xMutexInit = cp.xMutexInit;
                xMutexEnd = cp.xMutexEnd;
                xMutexAlloc = cp.xMutexAlloc;
                xMutexFree = cp.xMutexFree;
                xMutexEnter = cp.xMutexEnter;
                xMutexTry = cp.xMutexTry;
                xMutexLeave = cp.xMutexLeave;
                xMutexHeld = cp.xMutexHeld;
                xMutexNotheld = cp.xMutexNotheld;
            }
        }
