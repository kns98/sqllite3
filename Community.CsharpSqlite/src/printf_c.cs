...
for(idx = precision, rounder = 0.4999; idx>0; idx--, rounder *= 0.1);
            ...
            if ( Double.IsNaN( realvalue ))
                    ...
                    case etSRCLIST:
                    {
                        var pSrc = va_arg(ap, (SrcList)null);
                        var k = va_arg(ap, 0);
                        var pItem = pSrc.a[k];
        ...
        */
        private static readonly StrAccum acc = new StrAccum(SQLITE_PRINT_BUF_SIZE);

        private static string sqlite3VMPrintf(sqlite3 db, string zFormat, params object[] ap)
        {
            if (zFormat == null)
                return null;
            if (ap.Length == 0)
        ...
        ** %-conversion extensions.
        */
        private static string sqlite3MPrintf(sqlite3 db, string zFormat, params object[] ap)
        {
            string z;
            //va_list ap;
            lock (lock_va_list)
        ...
        **
        */
        private static string sqlite3MAppendf(sqlite3 db, string zStr, string zFormat, params object[] ap)
        {
            string z;
            //va_list ap;
            lock (lock_va_list)
        ...
        */
        public static void sqlite3_vsnprintf(int n, StringBuilder zBuf, string zFormat, params object[] ap)
        {
            //StrAccum acc = new StrAccum( SQLITE_PRINT_BUF_SIZE );
            if (n <= 0)
                return;
        ...
        public static void sqlite3_snprintf(int n, StringBuilder zBuf, string zFormat, params object[] ap)
        {
            //string z;
            //va_list ap;
            lock (lock_va_list)
    ...
    */
        private static void sqlite3DebugPrintf(string zFormat, params object[] ap)
        {
            //va_list ap;
            lock (lock_va_list)
            {
