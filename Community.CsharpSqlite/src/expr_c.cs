    ...
    public partial class Sqlite3
    {
        ...
        */
        private static byte binaryCompareP5(Expr pExpr1, Expr pExpr2, int jumpIfNull)
        {
            ...
            aff = (byte)((byte)sqlite3CompareAffinity(pExpr1, (char)aff) | (byte)jumpIfNull);
            return aff;
        }
...
sqlite3Dequote(ref pNew.u._zToken);
        ...
        */
        ...
        )
        {
            ...
            if (p != null) sqlite3ExprCheckHeight(pParse, p.nHeight);
            return p;
        }
        ...
        */
        private static void sqlite3ExprAssignVarNumber(Parse pParse, Expr pExpr)
        {
            ...
            {
                short x = 0;
                var n = sqlite3Strlen30(z);
                if (z[0] == '?')
                {
                    /* Wildcard of the form "?nnn".  Convert "nnn" to an integer and
                    ** use it as the variable number */
                    long i = 0;
                    var bOk = 0 == sqlite3Atoi64(z.Substring(1), ref i, n - 1, SQLITE_UTF8);
                    pExpr.iColumn = x = (short)i;
                    testcase(i == 0);
                    testcase(i == 1);
                    ...
                    if (i > pParse.nVar) pParse.nVar = (int)i;
                }
                else
                {
                    ...
                    */
                    ...
                    for (i = 0; i < pParse.nzVar; i++)
                        if (pParse.azVar[i] != null &&
                            z.CompareTo(pParse.azVar[i]) == 0) //memcmp(pParse.azVar[i],z,n+1)==0 )
                        {
                            pExpr.iColumn = x = (short)(i + 1);
                            break;
                        }

                    if (x == 0) x = pExpr.iColumn = (short)++pParse.nVar;
                }
...
sqlite3DbFree( db, ref p.u._zToken );
            ...
            if (!ExprHasProperty(p, EP_Static)) sqlite3DbFree(db, ref p);
        }
        ...
        */
        ...
        private static Select sqlite3SelectDup(sqlite3 db, Select p, int flags)
        {
            ...
            pNew.iLimit = 0;
            pNew.iOffset = 0;
            pNew.selFlags = (ushort)(p.selFlags & ~SF_UsesEphemeral);
...
return null;
    ...
    */
        ...
        */
        ...
        {
            if (sqlite3ExprCanBeNull(pExpr) != 0) sqlite3VdbeAddOp2(v, OP_IsNull, iReg, iDest);
        }
        ...
        private static int sqlite3FindInIndex(Parse pParse, Expr pX, ref int prNotFound)
        {
            ...
            */
            ...
            if (eType == 0)
            {
                ...
                */
                var savedNQueryLoop = pParse.nQueryLoop;
                var rMayHaveNull = 0;
                eType = IN_INDEX_EPH;
                ...
                else
                {
                    ...
                    pParse.nQueryLoop = 1;
                    if (pX.pLeft.iColumn < 0 && !ExprHasAnyProperty(pX, EP_xIsSelect)) eType = IN_INDEX_ROWID;
                }
    ...
    */
        ...
        )
        {
            ...
            var rReg = 0; /* Register storing resulting */
            ...
            */
            ...
            switch (pExpr.op)
            {
                case TK_IN:
                {
                    ...
                    var pLeft = pExpr.pLeft; /* the LHS of the IN operator */
                    ...
                    */
                    ...
                    if (ExprHasProperty(pExpr, EP_xIsSelect))
                    {
                        ...
                        */
                        ...
                        if (sqlite3Select(pParse, pExpr.x.pSelect, ref dest) != 0) return 0;
                ...
                default:
                {
                    ...
                    */
                    ...
                    pSel.iLimit = 0;
                    if (sqlite3Select(pParse, pSel, ref dest) != 0) return 0;
                    rReg = dest.iParm;
    ...
    */
        ...
        {
            var rRhsHasNull = 0; /* Register that is true if RHS contains NULL values */
            ...
            */
            ...
            {
                var addr1 = sqlite3VdbeAddOp1(v, OP_NotNull, r1);
...
return;
        ...
        */
        ...
        )
        {
            ...
            if (iCol >= 0) sqlite3ColumnDefault(v, pTab, iCol, regOut);
        }
            ...
            switch (op)
            {
                ...
                case TK_FUNCTION:
                {
                    ...
                    */
                    ...
                    {
                        var endCoalesce = sqlite3VdbeMakeLabel(v);
...
*/
                    ...
                    else if (nFarg > 0) pDef = sqlite3VtabOverloadFunction(db, pDef, nFarg, pFarg.a[0].pExpr);
#endif
                    for (i = 0; i < nFarg; i++)
                    {
                    ...
                    sqlite3VdbeAddOp4(v, OP_Function, constMask, r1, target,
                        pDef, P4_FUNCDEF);
                    sqlite3VdbeChangeP5(v, (byte)nFarg);
                ...
                case TK_IN:
                {
                    var destIfFalse = sqlite3VdbeMakeLabel(v);
                    var destIfNull = sqlite3VdbeMakeLabel(v);
                    sqlite3VdbeAddOp2(v, OP_Null, 0, target);
        ...
        */
                ...
                case TK_TRIGGER:
                {
                    ...
                    */
                    var pTab = pExpr.pTab;
                    var p1 = pExpr.iTable * (pTab.nCol + 1) + 1 + pExpr.iColumn;
                ...
                */
...
#if !NDEBUG
                    var iCacheLevel = pParse.iCacheLevel;
                ...
                case TK_RAISE:
                {
                    ...
                    if (pExpr.affinity == OE_Abort) sqlite3MayAbort(pParse);
                    Debug.Assert(!ExprHasProperty(pExpr, EP_IntValue));
        ...
        */
        ...
        )
        {
            ...
            {
                pItem = pList.a[i];
                var pExpr = pItem.pExpr;
                var inReg = sqlite3ExprCodeTarget(pParse, pExpr, target + i);
                if (inReg != target + i)
        ...
        */
        ...
        )
        {
            ...
            var regFree1 = 0; /* Temporary use register */
        ...
        */
        private static int sqlite3ExprCompare(Expr pA, Expr pB)
        {
            ...
            {
                if (!ExprHasProperty(pB, EP_IntValue) || pA.u.iValue != pB.u.iValue) return 2;
            }
            else if (pA.op != TK_COLUMN && pA.u.zToken != null)
            {
                if (ExprHasProperty(pB, EP_IntValue) || NEVER(pB.u.zToken == null))
                    return 2;
                if (!pA.u.zToken.Equals(pB.u.zToken, StringComparison.InvariantCultureIgnoreCase)) return 2;
            }
        ...
        */
        private static int sqlite3ExprListCompare(ExprList pA, ExprList pB)
        {
            ...
            {
                var pExprA = pA.a[i].pExpr;
                var pExprB = pB.a[i].pExpr;
                    ...
                    if (pNC.nDepth == 0)
                    {
                        ...
                        */
                        ...
                        for (i = 0; i < pAggInfo.nFunc; i++)
                        {
                            ...
                            if (sqlite3ExprCompare(pItem.pExpr, pExpr) == 0) break;
                        }
