    ...
    */
        ...
        */
        ...
        )
        {
            ...
            var idx = 0; /* Index of a host parameter */
            var nextIndex = 1; /* Index of next ? host parameter */
            int n; /* Length of a token prefix */
            var nToken = 0; /* Length of the parameter token */
            int i; /* Loop counter */
...
sqlite3VdbeMemRelease(&utf8);
                    ...
                    else
                    {
                        ...
                        for (i = 0; i < pVar.n; i++) sqlite3XPrintf(_out, "%02x", pVar.zBLOB[i] & 0xff);
