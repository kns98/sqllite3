...
namespace Community.CsharpSqlite
{
    ...
    public partial class Sqlite3
    {
        ...
        */
        ...
        public delegate int dxFileControl(sqlite3_file File_ID, int op, ref long pArgs);
        ...
        public delegate int dxRead(sqlite3_file File_ID, byte[] buffer, int amount, long offset);

        public delegate int dxSectorSize(sqlite3_file File_ID);

        public delegate int dxSync(sqlite3_file File_ID, int flags);

        public delegate int dxTruncate(sqlite3_file File_ID, long size);

        public delegate int dxUnlock(sqlite3_file File_ID, int locktype);

        public delegate int dxWrite(sqlite3_file File_ID, byte[] buffer, int amount, long offset);
        ...
        public delegate int dxCurrentTimeInt64(sqlite3_vfs pVfs, ref long pTime);

        public delegate int dxSetSystemCall(sqlite3_vfs pVfs, string zName, long sqlite3_syscall_ptr);

        public delegate int dxGetSystemCall(sqlite3_vfs pVfs, string zName, long sqlite3_syscall_ptr);

        public delegate int dxNextSystemCall(sqlite3_vfs pVfs, string zName, long sqlite3_syscall_ptr);
        ...
        public delegate void
            dxCodecSizeChng(codec_ctx pCodec, int pageSize,
                short nReserve); //void (*xCodecSizeChng)(void*,int,int); /* Notify of page size changes */
        ...
        public delegate int smdxRowid(sqlite3_vtab_cursor pCursor, out long pRowid);

        public delegate int smdxUpdate(sqlite3_vtab pVTab, int p1, sqlite3_value[] p2, out long p3);
        ...
        public delegate int dmxRowid(sqlite3_vtab_cursor pCursor, long pRowid);

        public delegate int dmxUpdate(sqlite3_vtab pVTab, int i2, sqlite3_value sv3, long v4);
        ...
        public delegate PgHdr dxPC_Fetch(sqlite3_pcache pCache, uint key, int createFlag);

        public delegate void dxPC_Unpin(sqlite3_pcache pCache, PgHdr p2, bool discard);

        public delegate void dxPC_Rekey(sqlite3_pcache pCache, PgHdr p2, uint oldKey, uint newKey);

        public delegate void dxPC_Truncate(sqlite3_pcache pCache, uint iLimit);
