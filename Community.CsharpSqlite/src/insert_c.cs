    ...
    public partial class Sqlite3
    {
        ...
        */
        private static bool readsTable(Parse p, int iStartAddr, int iDb, Table pTab)
        {
            ...
            var pVTab = IsVirtual(pTab) ? sqlite3GetVTable(p.db, pTab) : null;
#endif
...
isView = false;
      ...
      */
            ...
            */
            ...
            {
                var regCols = sqlite3GetTempRange(pParse, pTab.nCol + 1);
      ...
      */
        ...
        */
        ...
        )
        {
            ...
            var regOldRowid = rowidChng != 0 && isUpdate ? rowidChng : regRowid;
      ...
      */
            if (rowidChng != 0)
            {
                ...
                if (isUpdate) j2 = sqlite3VdbeAddOp3(v, OP_Eq, regRowid, 0, rowidChng);
        ...
        */
        ...
        )
        {
            ...
            if (pParse.nested == 0) sqlite3VdbeChangeP4(v, -1, pTab.zName, P4_TRANSIENT);
        ...
        )
        {
            ...
            */
            ...
            if (pDest.pCheck != null &&
                0 != sqlite3ExprCompare(pSrc.pCheck,
            ...
            */
            if ((pParse.db.flags & SQLITE_ForeignKeys) != 0 && pDest.pFKey != null) return 0;
#endif
